          ...
          return (
            <Tbody key={tag.name} isExpanded={isTagExpanded(tag)}>
              <Tr>
                ...
                {/* TODO: get this info later  */}
                <Td dataLabel={columnNames.Security}>
                  {typeof tag.ManifestLists != 'undefined'
                    ? 'See Child Manifest'
                    : tag.security}
                </Td>
                <Td dataLabel={columnNames.Size}>
                  {typeof tag.ManifestLists != 'undefined' ? 'N/A' : tag.size}
                </Td>
